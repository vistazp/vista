...
<div id="steps" class="span-24 last">
	 <form accept-charset="UTF-8" action="/post/jobs" class="new_job" id="new_job" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="z3tVa/QxSLZWcMP/dYhNj3/D1oLXg+8E3schsdIvRCk=" /></div>
      ...
      <div class="tier-box">
        ...
        <p class="footer">
          <label class='label-radio ' for='job_featured_status_1'>
            <input class="featured_status" id="job_featured_status_1" name="job[featured_status]" type="radio" value="1" /><strike>$99</strike>
      ...
      <div class="tier-box">
        ...
        <p class="footer">
          <label class='label-radio label-radio-check' for='job_featured_status_2'>
            <input checked="checked" class="featured_status" id="job_featured_status_2" name="job[featured_status]" type="radio" value="2" /><strike>$149</strike> 
  ...
  <div id="get-started" class="span-24 last">
    ...
    <div class="span-12" name="step-1-fields-section">
      ...
      <div class="span-12 last">
        ...
        <input class="required" id="job_headline" name="job[headline]" size="50" title="Please enter a Post Title" type="text" />
      </div>
      <div id="job-where" class="span-12 last">
        <div class="span-6">
          <strong>Where? *</strong><span class="hint">(City / State)</span>
          <input class="required" id="job_city" name="job[city]" size="22" title="Please enter a City/State" type="text" />
        </div>
...
<option value="Zimbabwe">Zimbabwe</option></select>
      ...
      <div class="span-12 last">
        ...
        <input id="job_referrer_code" name="job[referrer_code]" size="40" type="text" />
      </div>
    </div>
    <!-- right column -->
...
<div title="Account login" id="newAccountForm"  style="display:  none ">
    ...
    <label for="new_user_terms">
      ...
      <a href="/terms" target="_blank">Terms for Use</a> and <a href="/privacy" target="_blank">Privacy Policy</a>
    </label>
</div>
